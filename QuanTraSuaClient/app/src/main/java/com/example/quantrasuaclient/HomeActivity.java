...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.quantrasuaclient.databinding.ActivityHomeBinding binding = ActivityHomeBinding.inflate(getLayoutInflater());
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_menu, R.id.nav_cart, R.id.nav_view_orders, R.id.nav_favorite)
    ...
    //Dang ki su kien click cho category
    ...
    //Dang ky su kien cho menu item cart
    @Subscribe(sticky = true, threadMode = ThreadMode.MAIN)
