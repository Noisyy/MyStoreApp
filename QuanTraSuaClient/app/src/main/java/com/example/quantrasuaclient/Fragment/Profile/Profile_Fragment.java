...
public class Profile_Fragment extends Fragment {
    ...
    private void updateProfile(Map<String, Object> update_profile) {
        FirebaseDatabase.getInstance()
                ...
                .addOnCompleteListener(task -> Toast.makeText(getContext(), "Cập nhật thành công!", Toast.LENGTH_SHORT).show());
    ...
    private void setUserInformation() {
        if (Common.currentUser != null) {
            ...
            if (Common.currentUser.getImage() != null) {
                Glide.with(this).load(Common.currentUser.getImage()).into(imgAvatar);
            } else {
                Glide.with(this).load(R.drawable.app_icon).into(imgAvatar);
            }
        }
    }
