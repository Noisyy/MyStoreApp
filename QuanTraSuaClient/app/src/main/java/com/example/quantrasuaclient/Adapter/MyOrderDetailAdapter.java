...
public class MyOrderDetailAdapter extends RecyclerView.Adapter<MyOrderDetailAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        {
            List<AddonModel> addonModels = gson.fromJson(cartItemList.get(position).getDrinksAddon(), new TypeToken<List<AddonModel>>() {
            }.getType());
            ...
            if (addonModels != null) {
                ...
                addonString.delete(addonString.length() - 2, addonString.length()); //Remove last "," character
