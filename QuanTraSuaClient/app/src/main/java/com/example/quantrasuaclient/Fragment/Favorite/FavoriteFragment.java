package com.example.quantrasuaclient.Fragment.Favorite;
...
import com.example.quantrasuaclient.databinding.FragmentFavoriteBinding;
...
public class FavoriteFragment extends Fragment {
    ...
    private void loadFavoriteItem() {
        ...
        compositeDisposable.add(Common.favoriteRepository.getFavItem()
                ...
                .subscribe(this::displayFavoriteItem));
    }
