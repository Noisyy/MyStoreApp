...
public interface LatLngInterpolator {
    ...
    class Linear implements LatLngInterpolator {
        ...
        public LatLng interpolate(float fraction, LatLng a, LatLng b) {
            ...
            double lng = (b.latitude - a.latitude) * fraction + a.longitude;
    ...
    class Spherical implements LatLngInterpolator {
        ...
        public LatLng interpolate(float fraction, LatLng from, LatLng to) {
            ...
            double angle = computerAngelBetween(fromLat, fromLng, toLat, toLng);
        ...
        private double computerAngelBetween(double fromLat, double fromLng, double toLat, double toLng) {
